...
public class MapOfList {
    public static final Map<Person, List< ? extends Pet>>//还有？牛
//    public static final Map<Person, List<Pet>>//还有？牛
    ...
    public static void main(String[] args) {
        ...
        for(Person person : petPeople.keySet()) {
            ...
            for(Pet pet : petPeople.get(person))//petPeople.get(person)拿出来是个List
